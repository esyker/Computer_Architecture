...
-- UNCOMMENT THE LINES CORRESPONDING TO YOUR OPCODES
  ...
  --------------------------------------------------------------------------------------------------------------------------------  
          0 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"0"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ADD    R[DR],R[SA],R[SB]
          1 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"0"   &  "001"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "00",  -- ADDI   R[DR],R[SA],SIMM18
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- SUB    R[DR],R[SA],R[SB]
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- SUBI   R[DR],R[SA],SIMM18
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
          4 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"4"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- AND    R[DR],R[SA],R[SB]
...
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- NOR    R[DR],R[SA],R[SB]
          12 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"8"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- XOR    R[DR],R[SA],R[SB]
...
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ASL    R[DR],R[SB]
          19 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"D"   &  "000"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "00",  -- ASR    R[DR],R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
          20 =>  '0' &   x"0"  &  x"0"   &  x"0"   &  x"0"   &  "000"  &  "00"  &  "00"  &  "11"  & "00"  &  '0' &  "01",  -- LD     R[DA],(R[AA]+R[BA])
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- LDI    R[DA],(R[AA]+SIMM18)
--          0 =>  '?' &   x"?"  &  x"?"   &  x"?"   &  x"?"   &  "???"  &  "??"  &  "??"  &  "??"  & "??"  &  '?' &  "??",  -- ST     (R[AA]+SIMM18),R[SB]
  --------------------------------------------------------------------------------------------------------------------------------  
  -- OPCODE =>  PL  &  dAA    & dBA     & dDA     &  FS     &  KNSSel &  MASel &  MBSel &  MMA   & MMB   &  MW  &  MDSel
  --------------------------------------------------------------------------------------------------------------------------------  
          23 =>  '1' &   x"0"  &  x"0"   &  x"0"   &  x"3"   &  "011"  &  "00"  &  "00"  &  "00"  & "00"  &  '0' &  "10",  -- B.cond  (R[SA] cond R[SB]),SIMM14
          24 =>  '1' &   x"0"  &  x"0"   &  x"0"   &  x"3"   &  "011"  &  "00"  &  "01"  &  "00"  & "00"  &  '0' &  "10",  -- BI.cond (R[SA] cond SIMM14),R[SB]
